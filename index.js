...
audio35 = fs.readFileSync('./X4/nyz35.m4a') 
			...
			if (!packname) packname = 'mochinbot-wa'; if (!author) author = ' budy';
			...
			if (buttonsR === 'ALLMENU') {
			menu2 = fs.readFileSync('./X3/manz.jpg') 
		    ...
		    switch(command) {
		    case 'textpro':		    
		    helpz2 = fs.readFileSync(`./X3/manz.jpg`) 
		    ...
		    break				    		 
		    case 'audiomenu':		    
		    helpz22 = fs.readFileSync(`./X3/manz.jpg`) 
		    ...
		    break				    		 
		    case 'grubmenu':		    
		    helpzz2 = fs.readFileSync(`./X3/manz.jpg`) 
		    ...
		    break				    		 
		    case 'gamemenu':		    
		    helpzzz2 = fs.readFileSync(`./X3/manz.jpg`) 
		    ...
		    break				    		 
		    case 'imageanime':		    
		    helpzzzz2 = fs.readFileSync(`./X3/manz.jpg`) 
		    ...
		    break				    		 
		    case 'ownermenu':		    
		    helpzq2 = fs.readFileSync(`./X3/manz.jpg`) 
		    ...
		    break				    		 
		    case 'randomanime':		    
		    helpzqq2 = fs.readFileSync(`./X3/manz.jpg`) 
		    ...
		    break				    		 
		    case 'randommenu':		    
		    helpzqqq2 = fs.readFileSync(`./X3/manz.jpg`) 
		    ...
		    break				    		 
		    case 'randomtext':		    
		    helpzv2 = fs.readFileSync(`./X3/manz.jpg`) 
		    ...
		    break				    		 
		    case 'raterandom':		    
		    helpzvv2 = fs.readFileSync(`./X3/manz.jpg`) 
		    ...
		    break				    		 
		    case 'sticktagrandom':		    
		    helpzvvv2 = fs.readFileSync(`./X3/manz.jpg`) 
		    ...
		    break				    		 
		    case 'vcardrandom':		    
		    helpzx2 = fs.readFileSync(`./X3/manz.jpg`) 
		    ...
		    break				    		 
		    case 'tagrandom':		    
		    helpzxx2 = fs.readFileSync(`./X3/manz.jpg`) 
		    ...
		    break				    		 
		    case 'asupan':		    
		    helpzxxx2 = fs.readFileSync(`./X3/manz.jpg`) 
		    ...
		    break				    		 
		    case 'search':		    
		    helpzw2 = fs.readFileSync(`./X3/manz.jpg`) 
			...
			case 'sticker':  
         	...
         	.on('end', function () {
         	console.log('SELESAI JANGAN LUPA SUPPORT')
            ...
            break  
            case 'stalkyt':
            if (args.length < 1) return query("mochin")
            ...
            if (args.length < 1) return query("manz")
            reply(mess.wait)
            try{
